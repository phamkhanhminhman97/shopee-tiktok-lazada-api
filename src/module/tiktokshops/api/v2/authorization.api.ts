...
import { commonParameter, genURLwithSignature, httpGet } from '../../common/helper';
...
export async function getAuthorizedShop(config: TiktokConfig): Promise<TiktokResponseAuthorized> {
  ...
  const url = genURLwithSignature(TIKTOK_PATH_202309.AUTHORIZED_SHOP, commonParam, config);
