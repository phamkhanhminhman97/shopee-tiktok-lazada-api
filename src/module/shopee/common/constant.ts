...
enum PATH {
  ...
  MASS_SHIPPING_PARAMS = '/api/v2/logistics/get_mass_shipping_parameter',
  SHIP_ORDER = '/api/v2/logistics/ship_order',
  MASS_SHIP_ORDER = '/api/v2/logistics/mass_ship_order',
  ...
  MASS_TRACKING_NUMBER = '/api/v2/logistics/get_mass_tracking_number',
